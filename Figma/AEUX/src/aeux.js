...
function getText(layer, parentFrame) {
    ...
    var multiplier = layer.lineHeight.value == layer.fontSize && layer.lineHeight.unit == "PIXELS"? 1.2 : 0.9 ;
    // var multiplier = 0.9;
    frame = {
        width: layer.width,
        height: layer.height,
    ...
    function getLineHeight(layer) {
        if (layer.lineHeight.unit == 'PIXELS') {
            ...
            // line height set to auto, 1.2 coeffcient is default multiplier for many types of fonts to calculate leading,
    ...
    function getTracking(layer) {
        if (layer.letterSpacing.unit == 'PIXELS') {
            ...
            // return layer.letterSpacing.value / layer.fontSize * 1200;
